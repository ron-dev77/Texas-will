...
export function buildSpousalTrustArticleSole(params: {
  ...
  return {
    ...
    paragraphs: [
      ...
      `Termination and Remainder Distribution. Upon the death of my spouse, the Trustee shall distribute the remaining principal and any undistributed income of the ${trustName} in equal shares to my children: ${childrenList}, per stirpes and not per capita.`,
...
export function buildSpousalTrustArticleCoTrustee(params: {
  ...
  return {
    ...
    paragraphs: [
      ...
      `Termination and Remainder Distribution. Upon the death of my spouse, the Co-Trustees shall distribute the remaining principal and any undistributed income of the ${trustName} in equal shares to my children: ${childrenList}, per stirpes and not per capita.`,
